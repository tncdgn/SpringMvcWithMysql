        ...
        <table class="responstable" id="personTable">
            ...
            <c:forEach items="${listPerson}" var="person" >
                <tr id="${person.personId}">
                    <td><input type="radio"  value='${person.personId}' id="selected" name="personData" onclick=""/></td>
                    <td id="selectedName"  >${person.name}</td>
                    <td id="selectedSurname">${person.surname}</td>
                    <td id="selectedAddress">${person.address}</td>
                    <td id="selectedPhoneNumber">${person.phoneNumber}</td>
    ...
    <div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
        <div class="cd-user-modal-container"> <!-- this is the container wrapper -->
            ...
            <div id="cd-login"> <!-- log in form -->
                <form:form class="cd-form" action="person" method="post" commandName="personForm" >
                    <p class="fieldset">
    ...
    <div class="cd-user-modal2"> <!-- this is the entire modal form, including the background -->
        <div class="cd-user-modal2-container2"> <!-- this is the container wrapper -->
            ...
            <div id="cd-edit"> <!-- log in form -->
                <form:form class="cd-form" action="person/edit" method="post" commandName="personEdit" >
                    <p class="fieldset">
